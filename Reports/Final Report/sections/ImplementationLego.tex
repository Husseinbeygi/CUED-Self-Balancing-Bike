After having completed the modelling and controller designs for both bicycles, the final designs were then be tested on the real-world system. Firstly, the implementation using the Lego prototype bicycle was investigated, since it was quickly assembled and easier to test in a confined space, compared to the full-scale bicycle.
