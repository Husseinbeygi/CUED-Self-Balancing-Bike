To be able to design suitable control laws to stabilise the bicycle, it is necessary to provide a mathematical description of the system. Additionally, developing a dynamical model of the system will give an insight into what factors influence the bicycle behaviour in terms of its stability.
	...
	\begin{tikzpicture}
		\begin{axis}
			[xlabel=Time (s),
			 ...
			 tick label style={/pgf/number format/fixed}]
			\addplot[mark=none,dashed] table[x=t,y=u, col sep=comma] {legoServoData.csv};
			\addplot[mark=none,color=blue] table[x=t,y=p1, col sep=comma] {legoServoData.csv};
			\addplot[mark=none,color=red] table[x=t,y=p2, col sep=comma] {legoServoData.csv};
			\addplot[mark=none,color=green] table[x=t,y=p5, col sep=comma] {legoServoData.csv};
	...
	\begin{tikzpicture}
		\begin{axis}
			[xlabel=Time (s),
			 ...
			 legend pos=north west,
			 tick label style={/pgf/number format/fixed}]
			\addplot[mark=none,color=red,dashed] table[x=t,y=true, col sep=comma] {legoServoVerification.csv};
			\addplot[mark=none,color=blue] table[x=t,y=model, col sep=comma] {legoServoVerification.csv};
			\legend{True, Model}			
		\end{axis}
	\end{tikzpicture}
	...
	\begin{tikzpicture}
		\begin{axis}
			[xlabel=Time (s),
			 ...
			 tick label style={/pgf/number format/fixed}]
			\addplot[mark=none,color=red,dashed] table[x=t,y=delta,col sep=comma] {FSServoData.csv};	
			\addplot[mark=none,color=blue] table[x=t,y=deltasim,col sep=comma] {FSServoData.csv};
			\legend{True,Model}
		\end{axis}
	\end{tikzpicture}
