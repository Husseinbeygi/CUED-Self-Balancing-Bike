...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.65]{BikeSim}
...
In this case, both the PID and LQR controllers have a more suitable response in comparison to the $H_{\infty}$ controller.
