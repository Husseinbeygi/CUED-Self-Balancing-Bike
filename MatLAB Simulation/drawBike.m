function drawBike(uu)
    ...
    persistent bike_handle;  % figure handle for UAV
    persistent Vertices
    persistent Faces
    ...
    if t==0
        ...
        bike_handle = drawBody(Vertices,Faces,facecolors,...
    ...
    % at every other time step, redraw quadrotor and target
        ...
        set(bike_handle.Parent, 'XLim',[pe-1000,pe+1000])
        set(bike_handle.Parent, 'YLim',[pn-1000,pn+1000])
    end
end
